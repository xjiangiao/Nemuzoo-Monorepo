...
The storefront wraps absolute Medusa image URLs in ImageKit's encoded web proxy format, so the Medusa backend and stored product image URLs do not need to change.
